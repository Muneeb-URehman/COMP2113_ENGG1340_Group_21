    ...
    while (true) {
        ...
        else if (choice == 2)
        {
            ...
            while (inp != KEY_ENTER && inp != 10)
            {
                ...
                erase();
                display->print_line("Welcome to Avengers Assemble! A turn-based puzzle game.", 10, 15);
                ...
                display->print_line("Hawkeye is the AI. Your mission is to ensure that it picks up the", 12, 15);
            ...
            display->print_line("- The game consists of a series of rounds where you and the AI alternate turns until all blocks are removed", 11, 15);
            display->print_line("so that Hawkeye retrieves the Soul Stone.", 12, 15);
            ...
            display->print_line("pillars changes with different levels.", 15, 15);
